...
void Slots::mostrarReglas() {
    ...
    cout << "En esta versión de Slots se generaran 3 numeros entre 1 y 7. Si caen los 3 numeros iguales el jugador ganará el doble de lo apostado, si consigue una escalera (numeros sucesivos sea ascendente o descendente) ganará la mitad de lo apostado. Si llega a conseguir el triple 7 ganará 7 veces lo apostado. Si no consigue ninguna perderá  lo apostado.\n";
}
